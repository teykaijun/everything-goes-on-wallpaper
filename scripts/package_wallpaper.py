...
FILES = [
    ...
    "layout.js", "bench-layout.js", "classroom.js", "classroom.css", "lux.js", "lux-motion.js", "media/lux/animation-data.js", "media/lux/model.js", "vendor/THREE-LICENSE.txt",
    "LivelyInfo.json", "LivelyProperties.json", "thumbnail.jpg",
    "media/day-clean.webm", "media/night-clean.webm", "media/window-magic/day.mp4", "media/window-magic/night.mp4", "media/day.ogg", "media/night.ogg"
]
...
def main():
    ...
    output = ROOT / "dist" / "Everything-Goes-On-Star-Window-Lively.zip"
