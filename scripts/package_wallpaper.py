...
FILES = [
    ...
    "media/day-clean.webm", "media/night-clean.webm", "media/window/day.mp4", "media/window/night.mp4", "media/day.ogg", "media/night.ogg"
]
...
def main():
    ...
    output = ROOT / "dist" / "Everything-Goes-On-Bench-Window-Lively.zip"
